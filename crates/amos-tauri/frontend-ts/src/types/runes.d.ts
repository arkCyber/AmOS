 ...
 * must still type-check `.svelte.ts` runes modules that React files import (e.g.
 * src/svelte/locale.svelte.ts via SvelteAppHost.tsx). These globals give tsc a
 * loose-but-correct shape so the macros type-check without erroring.
 *
