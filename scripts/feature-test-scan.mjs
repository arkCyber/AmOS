 ...
 */
import { readFileSync, readdirSync, existsSync, statSync, mkdtempSync, mkdirSync, writeFileSync, symlinkSync, rmSync } from "node:fs";
...
function runSelfTest() {
  ...
  const tmp = mkdtempSync(join(tmpdir(), "amos-feature-test-"));
  try {
